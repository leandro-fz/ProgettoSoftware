...
class Insieme_Iscritti():
    def __init__(self):
        ...
        self.lista_iscritti= []
        if os.path.isfile("struttura/palestra/iscritti/data_iscritti/lista_iscritti_salvata.pickle"):
            with open("struttura/palestra/iscritti/data_iscritti/lista_iscritti_salvata.pickle",
                      "rb") as file:
                try:
    ...
    def save_data(self):
        if os.path.isfile("struttura/palestra/iscritti/data_iscritti/lista_iscritti_salvata.pickle"):
            with open("struttura/palestra/iscritti/data_iscritti/lista_iscritti_salvata.pickle", "wb") as handle:
