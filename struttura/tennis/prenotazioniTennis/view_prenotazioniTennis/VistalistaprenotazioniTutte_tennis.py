...
from struttura.tennis.prenotazioniTennis.view_prenotazioniTennis.view_prenotazioneTennis import VistaPrenotazione
...
class VistaListaPrenotazioniTutte(QWidget):
    ...
    def dettagli_prenotazione(self):
        ...
        self.vista_prenotazione = VistaPrenotazione(ControllorePrenotazioneTennis(da_visualizzare))
