...
class Ui_gestionecampodacalcio(object):
    def setupUi(self, gestionecampodacalcio):
        gestionecampodacalcio.setObjectName("gestionecampodacalcio")
        gestionecampodacalcio.resize(781, 500)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(gestionecampodacalcio.sizePolicy().hasHeightForWidth())
        gestionecampodacalcio.setSizePolicy(sizePolicy)
        gestionecampodacalcio.setMinimumSize(QtCore.QSize(781, 500))
        gestionecampodacalcio.setMaximumSize(QtCore.QSize(781, 500))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("images/immaginelogo1.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        gestionecampodacalcio.setWindowIcon(icon)
        self.centralwidget = QtWidgets.QWidget(gestionecampodacalcio)
        ...
        gestionecampodacalcio.setCentralWidget(self.centralwidget)

        self.retranslateUi(gestionecampodacalcio)
        QtCore.QMetaObject.connectSlotsByName(gestionecampodacalcio)

    def retranslateUi(self, gestionecampodacalcio):
        _translate = QtCore.QCoreApplication.translate
        gestionecampodacalcio.setWindowTitle(_translate("gestionecampodacalcio", "Gestione campo da calcio"))
        self.aggiungiutente.setText(_translate("gestionecampodacalcio", "Aggiungi utente"))
        self.eliminautente.setText(_translate("gestionecampodacalcio", "Elimina utente"))
        self.visualizzautente.setText(_translate("gestionecampodacalcio", "Visualizza utente"))
        self.calendario.setText(_translate("gestionecampodacalcio", "Calendario"))
        self.freccia.setText(_translate("gestionecampodacalcio", "⬅️"))
        self.freccia.setShortcut(_translate("gestionecampodacalcio", "Alt+Left"))


# if __name__ == "__main__":
#     import sys
#     app = QtWidgets.QApplication(sys.argv)
#     gestionecampodacalcio = QtWidgets.QMainWindow()
#     ui = Ui_gestionecampodacalcio()
#     ui.setupUi(gestionecampodacalcio)
#     gestionecampodacalcio.show()
#     sys.exit(app.exec_())
