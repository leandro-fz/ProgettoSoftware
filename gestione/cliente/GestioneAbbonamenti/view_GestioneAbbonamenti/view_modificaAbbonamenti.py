...
class view_ModificaAbbonamento(QWidget):
    ...
    def __init__(self, controllore_abbonamento, aggiorna_lista, lista_abbonamenti, parent=None):
        ...
        self.campo_ruolo.setText(self.controller.get_ruolo_abbonamento())
        ...
        self.campo_id.setText(str(self.controller.get_id_abbonamento()))
        ...
        self.campo_stipendio.setText(str(self.controller.get_stipendio_abbonamento()))
    ...
    def modifica_abbonamento(self):
        ...
        if self.controller.get_id_abbonamento() == id:
            pass
        ...
        self.controller.set_ruolo_abbonamento(ruolo)
        self.controller.set_id_abbonamento(id)
        self.controller.set_stipendio_abbonamento(stipendio)
